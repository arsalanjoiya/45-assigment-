...
let myPizza = ["cheese pizza", "chekan pizza", "spicy pizza"];
...
console.log(
    `\nI really like to eat pizza. pizza come in a variety of flavors and tooping, allowing individuals to customize it to their liking`
)
